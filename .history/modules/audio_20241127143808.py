    ...
    try:
        ...
        for i, subtitle in enumerate(subtitles):
            ...
            if audio_file.exists():
                ...
                # 添加音频处理过滤器
                filter_parts.append(
                    f'[{valid_audio_count + 1}:a]volume=1.5,afade=t=in:st=0:d=0.5,afade=t=out:st={duration-0.5}:d=0.5,adelay={int(start_time*1000)}|{int(start_time*1000)}[delayed{valid_audio_count}];'
                )
                valid_audio_count += 1
